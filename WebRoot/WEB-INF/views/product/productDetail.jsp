...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
	<title>${productCurrent.productTitle}_广州品韵信息科技有限公司</title>
...
<div class="solution_box">
  <div class="solution_left_box">
    <div class="solution_menu_box">
	  ...
	  <c:forEach items="${list_product }" var="product"> 
      	<div class="solution_menu_box_title_no2"> <a href="${ctx }/product/productDetail.do?pid=${product.productId}" class="a2">${product.productTitle}</a></div>
      </c:forEach>
  ...
  <div class="solution_right_box">
    <div class="solution_right_box_t_bg">
      ...
      <div class="intermap"> 当前位置:<a href="${ctx }/index.do" class="a3">首页</a> &gt;&gt;
          <a href="${ctx }/product/productCenter.do" class="a3"><font>产品中心</font></a>&gt;&gt;
          <font color="#FF0000">${productCurrent.productTitle }</font>
      </div>
    </div>
    <div class="solution_fenlei_no1_box">
        <div class="solution_fenlei1_t">
          	<div class="company_names"> <font face="微软雅黑" color="#0033FF">${productCurrent.productTitle}</font></div>
   		</div>
   		<img src="/gzpy_manage${productCurrent.imagePath }" width="720" height="405" alt=""/><br/><br/>
...
<script src="${ctx }/css_files/common.js" type="text/javascript"></script>
<div class="foot">
	<div class="foot_text">Copyright(C)2013-2016 广州品韵信息科技有限公司 版权所有 粤ICP备16089509号</div>
</div>
</body>
</html>