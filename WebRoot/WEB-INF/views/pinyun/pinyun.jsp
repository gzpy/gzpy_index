  ...
  <div class="solution_right_box">
    ...
    <div class="compan">
      <div class="compan_pic">
        ...
        <c:forEach items="${list_news1 }" var="news1">
       
      
        	<c:if test="${news1.imagePath!=null }">
   			<img src="/gzpy_manage${news1.imagePath }" width="720" height="405" alt=""/><br/><br/>
   			</c:if>
   			<c:if test="${news1.newsContent!=null }">
			...
			${news1.newsContent }
      		 ...
      		 <c:forEach items="${list_news2 }" var="news2">
        	<c:if test="${news2.imagePath!=null }">
   			<img src="/gzpy_manage${news2.imagePath }" width="720" height="405" alt=""/><br/><br/>
   			</c:if>
   			<c:if test="${news2.newsContent!=null }">
        	<div style="text-align: center;">
			<section class="wx96Diy" data-source="bj.96weixin.com">
			<section class="96wx-bdtc" style="border-width: 0px; border-style: none; border-top-color: rgb(0, 0, 0); padding: 0px;">
			<section class="96wx-bdc" style="margin: 10px 0px; padding: 0px; border: 3px solid rgb(0, 0, 0); box-sizing: border-box; width: 100%; display: inline-block;">
         ...
         <c:forEach items="${list_news3}" var="news3">
        	<c:if test="${news3.imagePath!=null }">
   			<img src="/gzpy_manage${news3.imagePath }" width="720" height="405" alt=""/><br/><br/>
   			</c:if>
   			<c:if test="${news3.newsContent!=null }">
        	<div style="text-align: center;">
			<section class="wx96Diy" data-source="bj.96weixin.com">
			<section class="96wx-bdtc" style="border-width: 0px; border-style: none; border-top-color: rgb(0, 0, 0); padding: 0px;">
			<section class="96wx-bdc" style="margin: 10px 0px; padding: 0px; border: 3px solid rgb(0, 0, 0); box-sizing: border-box; width: 100%; display: inline-block;">
