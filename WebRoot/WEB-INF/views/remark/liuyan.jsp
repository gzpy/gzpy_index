...
<div class="solution_box">
  <div class="solution_left_box">
    <div class="solution_menu_box">
      ...
      <!--  <div class="solution_menu_box_title_no1">
	  		<a href="#1234" class="a2"><font color="#0033CC">公司简介</font></a>
	  </div>-->
             <div class="solution_menu_box_title_no2"><a id="b71" href="know_pinyun.html" class="a2">关于品韵</a></div>
      <div class="solution_menu_box_title_no2"><a id="b74" href="aboutUs_zizhi.html" class="a2">公司资质</a></div>
      <div class="solution_menu_box_title_no2"><a href="aboutUs_honor.html" class="a2" >公司荣誉</a></div>
	  <!--
      <div class="solution_menu_box_title_no2"><a id="b76" href="http://www.hehang.net/AboutUs.aspx?CateId=76" class="a2">公司掠影</a></div>
	  -->
      <div class="solution_menu_box_title_no2"><a id="b97" href="connection_pinyun.html" class="a2">联系我们</a></div>
  ...
  <div class="solution_right_box">
      ...
      <div class="neiye_title"><font face="微软雅黑" color="#0033FF">在线留言</font></div>
      <div class="intermap">当前位置:<a href="${ctx }/index/toIndex.do" class="a3">首页</a>&gt;&gt;<font color="#FF0000">在线留言</font></div>
    </div>
   <div class="solution_fenlei_no1_box">
   <tr>
              <td colspan="2" class="neiye_con">
              
  <form action="${ctx}/remark/saveRemark.do" method="post" name="form1"  id="form1">
          <br>
          <table width="500" border="0" align="center" cellpadding="0" cellspacing="0" class="graya12">
            <tbody>
           
            <tr>
              <td height="30" class="graya14"><div align="center" class="STYLE2"></div></td>
              <td>&nbsp;&nbsp;
                姓名：  <input name="name" type="text" class="form1" id="name" ></td>
            </tr>
          
            <tr>
              <td height="30" class="graya14"><div align="center" class="STYLE2"></div></td>
              <td>&nbsp;&nbsp;
                邮箱：  <input name="email" type="text" class="form1" id="post" ></td>
            </tr>
            <tr>
              <td height="30" class="graya14"><div align="center" class="STYLE2"></div></td>
              <td>&nbsp;&nbsp;
               电话：   <input name="tel" type="text" class="form1" id="phone" ></td>
            </tr>
           
            <tr>
              <td class="graya14"><div align="center" class="STYLE2"></div></td>
              <td><label> &nbsp;&nbsp;
                 内容：   <textarea name="remarkContent" cols="65" rows="10" class="form1" id="text"></textarea>
              </label></td>
            </tr>
            <tr>
                  ...
                  <div align="center">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tbody><tr>
                        <td>&nbsp;&nbsp;
                            <div align="center">
                              <input name="Submit2" type="submit" id="btn" class="form1" value="发 送">
                              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
